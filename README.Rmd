...
Our `timeseriesTrajectory` package provides a suite of methods to analyze change patterns during 
...
You can install the development version of *`timeseriesTrajectory`* from [GitHub](https://github.com/) with:
